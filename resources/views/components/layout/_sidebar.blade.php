        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li class="mm-active">
                    ...
                    <ul>
                        <li>
                            <a href="{{route('dashboard')}}" {{in_array(url()->current(), [route('dashboard'), route('da.2')]) ? 'class=mm-active' : ''}}>
                                <i class="metismenu-icon"></i>Analytics
                            </a>
                        </li>
                        <li>
                            <a href="{{route('dc.1')}}" {{in_array(url()->current(), [route('dc.1'), route('dc.2')]) ? 'class=mm-active' : ''}}>
                                <i class="metismenu-icon"></i>Commerce
                            </a>
                        </li>
                        <li>
                            <a href="{{route('d.sales')}}" {{url()->current() === route('d.sales') ? 'class=mm-active' : ''}}>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="{{route('dm.1')}}" {{url()->current() === route('dm.1') ? 'class=mm-active' : ''}}>
                                        <i class="metismenu-icon"></i>Variation 1
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('dm.2')}}" {{url()->current() === route('dm.2') ? 'class=mm-active' : ''}}>
                        ...
                        <li>
                            <a href="{{route('d.crm.1')}}" {{in_array(url()->current(), [route('d.crm.1'), route('d.crm.2')]) ? 'class=mm-active' : ''}}>
                ...
                <li class="app-sidebar__heading">Topup</li>
                <li class="mm-active">
                    <a href="#">
                        <i class="metismenu-icon pe-7s-rocket"></i>Configuration
                        <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                    </a>
                    <ul>
                        <li>
                            <a href="{{route('tu.config')}}" {{in_array(url()->current(), [route('tu.config')]) ? 'class=mm-active' : ''}}>
